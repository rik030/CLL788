...
if __name__ == "__main__":
    ...
    """ Load the data """
    data_path = "/content/drive/MyDrive/CLL788/Term Paper/data"
    ...
    augment_data(train_x, train_y, "/content/drive/MyDrive/CLL788/Term Paper/new_data/train/", augment=True)
    augment_data(test_x, test_y, "/content/drive/MyDrive/CLL788/Term Paper/new_data/test/", augment=False)
